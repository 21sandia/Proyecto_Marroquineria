...
urlpatterns = [
    ...
    # Reports
    # path('report/sales/<start_date>/<end_date>/', viewsReports.sales_report, name='report/sales'),
    ...
    #  ?start_date=2023-01-01&end_date=2023-08-31&report_type=daily
    # ** Generar un informe semanal **
    #  ?start_date=2023-01-01&end_date=2023-08-31&report_type=weekly
    # ** Generar un informe mensual **
    #  ?start_date=2023-01-01&end_date=2023-08-31&report_type=monthly
    # ** Generar un informe anual **
    #  ?start_date=2023-01-01&end_date=2023-08-31&report_type=yearly
    # ** Generar informes diarios, semanales y mensuales **
    #  ?start_date=2023-01-01&end_date=2023-08-31&report_type=all
]
